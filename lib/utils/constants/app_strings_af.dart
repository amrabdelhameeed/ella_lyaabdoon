...
class AppStringsAf {
  ...
  static final String feedUrl = "http://164.160.104.175:6020/";
  ...
  //   Category('assets/icons/sectors/bank.svg', 'category:macroeconomy', 1),
  //   Category('assets/icons/sectors/resources.svg', 'category:finance', 2),
  //   Category('assets/icons/sectors/building.svg', 'category:realestate', 3),
  //   Category('assets/icons/sectors/construction.svg', 'category:healthcare', 4),
  //   Category('assets/icons/sectors/education.svg', 'category:telecom', 5),
  //   Category('assets/icons/sectors/food.svg', 'category:energy', 6),
  //   Category('assets/icons/sectors/health.svg', 'category:automotive', 7),
  //   Category('assets/icons/sectors/industrial.svg', 'category:industries', 8),
  //   Category('assets/icons/sectors/communication.svg', 'category:retail', 9),
  //   Category('assets/icons/sectors/financial.svg', 'category:education', 10),
  // ];
